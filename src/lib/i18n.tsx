...
const VI: Record<string, string> = {
  ...
  'Full mode': 'Chế độ toàn màn hình',
  'Full mode (Esc to exit)': 'Chế độ toàn màn hình (nhấn Esc để thoát)',
  'Exit full mode': 'Thoát chế độ toàn màn hình',
  'Exit Full Mode': 'Thoát toàn màn hình',
